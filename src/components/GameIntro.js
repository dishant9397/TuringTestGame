                ...
                <CardContent>
                    ...
                    <Typography className="start-introContent">
                        ...
                        <ul>
                            <li>NRC born and trained</li>
                            <li>
                                World-leading robot judge in mimicking human judge competitions
                            </li>
                            <li>
                                Judging rules:
                                <ul>
                                    ...
                                    <li>
                                        Weighing content word similarities higher than function word
                                        similarities
                                    </li>
                                    <li>
                                        Grouping a few words together in their order to judge
                                        fluency
                                    </li>
                                    <li>
                                        {' '}
                                        Ruling the highest scoring suspect as human; the second
                                        highest scoring one as Neuro and the lowest scoring one as
                                        State
                                    </li>
                                </ul>
                            </li>
